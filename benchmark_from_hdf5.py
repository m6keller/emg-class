...
"""
This script was edited from shallow_learn.py from https://github.com/biolab-put/putemg_examples
"""
            ...
            for i_s, s in enumerate(id_splits):
                ...
                for feature_set_name, features in feature_sets.items():
                    ...
                    for clf_id, clf_settings in classifiers.items():
                        ...
                        cm = confusion_matrix(y_true=test_y_true.values.astype(int), y_pred=test_y_pred, labels=list(gestures.keys()))
